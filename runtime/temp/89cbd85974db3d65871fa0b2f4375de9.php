...
<div class="page-content" style="padding:8px 10px 24px;">
    <form action="<?php echo url('index/articleUpdate',array('id'=>$data['id'])); ?>" method="post" name="myForm">
<table>

    <tr>
        <td style="text-align: center;">标题:</td><td><input type="text" name="title" style="width:1030px;" value="<?php echo htmlentities($data['title']); ?>"></td>
    </tr>

    <tr>
        <td style="text-align: center;">关键字</td><td><input type="text" name="keywords" style="width:1030px;" value="<?php echo htmlentities($data['keywords']); ?>"></td>
    </tr>

    <tr>
        <td width="80" style="text-align: center;">文章描述：</td><td><input type="text" name="description" style="width:1030px;height:60px;" value="<?php echo htmlentities($data['description']); ?>"></td>
    </tr>

    <tr>
        <td style="text-align: center;vertical-align: text-top">内容：</td><td><textarea id="content" type="text/plain" name="content" cols="30" rows="15" style="width:80%;"><?php echo $data['content']; ?></textarea></td>
    </tr>
    ...
    <tr>
    <td></td>
    <td><button class="btn btn-success" onclick="document.myForm.submit()">
            保存修改
    </button></td>
    </tr>
