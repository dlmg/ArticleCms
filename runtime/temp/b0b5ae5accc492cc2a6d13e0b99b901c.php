<?php /*a:1:{s:79:"D:\phpstudy_pro\WWW\articleAdmin\application\index\view\index\article_list.html";i:1585205125;}*/ ?>
<!--﻿-->
            ...
            <div class="row">
                ...
                <div class="news-right col-lg-9">
                    ...
                    <ul class="content-box">
                        ...
                        <li>
                            <h1><a href="<?php echo url('index/showDetail',array('id'=>$data['id'])); ?>" target="_blank" title="<?php echo htmlentities($data['title']); ?>"><?php echo htmlentities($data['title']); ?></a>
                            </h1>
