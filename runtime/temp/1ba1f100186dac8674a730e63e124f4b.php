<?php /*a:1:{s:72:"D:\phpstudy_pro\WWW\articleAdmin\application\admin\view\login\index.html";i:1584690049;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>登录界面</title>
		<meta name="keywords" content="登录，赛思特" />
		<meta name="description" content="这里是后台登录界面" />
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue">&copy; Company 赛思特</h4>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form action="<?php echo url('login/check'); ?>" method="post" name="postform">
												<fieldset>
													...
													<div class="clearfix">
														<button type="button" class="width-35 pull-right btn btn-sm btn-primary" onclick="document.postform.submit()";>
															<i class="icon-key"></i>
																登录
														</button>
													</div>
