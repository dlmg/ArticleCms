<?php /*a:1:{s:83:"D:\phpstudy_pro\WWW\articleAdmin\web\application\admin\view\index\article_list.html";i:1583913820;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8" />
		...
		<div class="sidebar" id="sidebar">
			...
			<ul class="nav nav-list">
				...
				<li>
					...
					<ul class="submenu">
						<li>
							<a href="<?php echo url('index/articleAdd'); ?>">
						...
						<li>
							<a href="<?php echo url('index/articleList'); ?>">
								<i class="icon-double-angle-right"></i>
								公告列表
							</a>
						</li>
						...
						<li>
							<a href="<?php echo url('index/siteMap'); ?>">
								<i class="icon-double-angle-right"></i>
								生成网站XML地图
							</a>
						</li>
			...
			<div class="page-content">
				...
				<table id="sample-table-1" class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td><?php echo htmlentities(date('Y-m-d',!is_numeric($data['date'])? strtotime($data['date']) : $data['date'])); ?></td>
						<td>
