<?php /*a:2:{s:79:"D:\phpstudy_pro\WWW\articleAdmin\application\admin\view\index\category_add.html";i:1585550423;s:73:"D:\phpstudy_pro\WWW\articleAdmin\application\admin\view\public\index.html";i:1585648462;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="page-content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="<?php echo url('admin/index/doAdd'); ?>" method="post" id="houtai">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="category" name="category" placeholder="请输入分类名称" class="col-xs-9 col-sm-9">
                    </div>
                </div>
