<?php /*a:2:{s:74:"D:\phpstudy_pro\WWW\articleAdmin\application\index\view\index\contact.html";i:1589424873;s:74:"D:\phpstudy_pro\WWW\articleAdmin\application\index\view\public\header.html";i:1589424817;}*/ ?>
...
<section class="j-contact" style="max-width: 960px;margin:0 auto;">
    <div class="container">
        <div class="j-tit">
            <p >郑州赛思特电子科技有限公司-郑州总公司</p>
        </div>
        <div class="j-conp">
            <div class="j-p">
                <b class="b3"></b>
                <span style="color: #007bff;">电话:</span><span>15188358607(提供7X24小时售前业务咨询、业务受理等)</span>
            </div>
            <div class="j-p">
                <b class="b1"></b><span style="color: #007bff;">公司地址:</span><span> 河南省郑州市金水区绿地之窗</span>
            </div>
     ...
     var viewH = window.screen.width;  //可见高度 
      ...
      if(viewH>768){
        ...
        function createMap(){
            ...
            var point = new BMap.Point(113.777372,34.767533);//定义一个中心点坐标
        ...
        //标注点数组
        var markerArr = [{title:"绿地之窗",content:"我的备注",point:"113.777354|34.767518",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}];
        //创建marker
        function addMarker(){
