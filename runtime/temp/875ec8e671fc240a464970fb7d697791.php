...
<title><?php echo htmlentities($data['title']); ?>--区块链落地应用|区块链开发|区块链平台|溯源区块链</title>
<meta name="description" content="<?php echo htmlentities($data['description']); ?>--赛思特科技是一家基于区块链虚拟币系统开发的数字货币交易所平台，专注为互联网金融领域的区块链钱包、区块链系统开发、数字货币开发及区块链技术开发问题提供数据共享资源解决方案" />
<meta name="keywords" content="<?php echo htmlentities($data['keywords']); ?>,区块链技术开发,虚拟币系统,数字货币交易所平台开发,区块链钱包开发">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="side-box col-md-3">
                    ...
                    <img src="/static/img/icon-i44.png" tppabs="/images/news/icon-i44.png">
                        <ul>
                            <li>全国咨询热线:</li>
                ...
                <!--右边内容-->
                <div class="news-right col-md-9">
                
                    <div class="ny-news">
                        <div class="ny-title">
                            <em><?php echo htmlentities($data['title']); ?></em>
                            <span><?php echo htmlentities(date('Y-m-d H:i:s',!is_numeric($data['date'])? strtotime($data['date']) : $data['date'])); ?></span>
                        </div>
                        <div class="ny-news-b">
                            <p>
...
<section id="foot" class="app-foot">
    ...
    <script language="javascript" src="/static/js/LsJS.aspx"></script><link href="/static/css/JS5.css" rel="stylesheet" type="text/css"><div id="LRdiv0" style="display:none;"></div><div id="LRdiv1" style="display:none;"></div><div id="LRdiv2" style="display:none;"></div><div id="LRdiv3" style="display:none;"></div>
    <!-- <script language="javascript">
