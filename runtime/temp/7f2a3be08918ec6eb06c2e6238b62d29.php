<?php /*a:2:{s:80:"D:\phpstudy_pro\WWW\articleAdmin\application\admin\view\index\category_edit.html";i:1585648436;s:73:"D:\phpstudy_pro\WWW\articleAdmin\application\admin\view\public\index.html";i:1585648462;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="page-content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" action="<?php echo url('admin/index/doCateEdit'); ?>" method="post" id="houtai">
                <h4 class="header green">
                    <i class="icon-hand-right green"></i>
                    请认真填写表单信息！
                </h4>
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="category"> 分类名称 </label>
                    <div class="col-sm-10">
                        <input type="text" id="category" name="category" value="<?php echo htmlentities($data['category']); ?>" class="col-xs-9 col-sm-9">
                    </div>
                </div>
...
<script>
    $(function(){
        $("#submit").click(function(){
            ...
            $.ajax({
                type: "POST",
                url:$("#houtai").attr("action"),
                data:$('#houtai').serialize(),
                success:function(msg){
                    if(msg.status == 200){
                        alert('修改成功');
                    }else{
                        swal("系统提示", msg.info, "error");
                    }
                }
            });
        });
