<?php /*a:2:{s:79:"D:\phpstudy_pro\WWW\articleAdmin\application\admin\view\index\article_cate.html";i:1585550474;s:73:"D:\phpstudy_pro\WWW\articleAdmin\application\admin\view\public\index.html";i:1585648462;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="page-content">
    <a href="<?php echo url('categoryAdd'); ?>"><button class=" btn btn-sm btn-primary"><i class="icon-search nav-search-icon">添加分类</i></button></a>
    <hr>
        ...
        <tr>
            ...
            <td>
                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                    <a class="green" href="<?php echo url('index/categoryEdit',array('id'=>$data['id'])); ?>">
                        <i class="icon-pencil bigger-130"></i>
                    </a>

                    <a class="red" href="<?php echo url('index/categoryDelete',array('id'=>$data['id'])); ?>" onclick="return confirm('确定要删除吗？')">
