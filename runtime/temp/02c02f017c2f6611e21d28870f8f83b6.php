...
<div class="page-content">
    <div class="row">
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
            <form class="form-horizontal" role="form" action="<?php echo url('admin/index/editPwd'); ?>" method="post" id="houtai">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="old_password" placeholder="请输入原始密码" class="col-xs-9 col-sm-9">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="new_password" placeholder="请输入新密码" class="col-xs-9 col-sm-9">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" name="con_password" placeholder="请输入新密码" class="col-xs-9 col-sm-9">
                    </div>
                </div>
        ...
        $("#submit").click(function(){
            ...
            $.ajax({
                ...
                success:function(msg){
                    if(msg.status == 200){
                        alert('密码修改成功');
                        window.location.href = "<?php echo url('admin/index/articleList'); ?>";
                    }else{
                        alert('密码修改失败');
                    }
                }
